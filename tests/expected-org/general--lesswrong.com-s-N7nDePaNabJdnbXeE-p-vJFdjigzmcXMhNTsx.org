...
:PROPERTIES:
:URL: https://lesswrong.com/s/N7nDePaNabJdnbXeE/p/vJFdjigzmcXMhNTsx
:AUTHOR: janus
...
:IMAGE: https://res.cloudinary.com/lesswrong-2-0/image/upload/c_fill,ar_1.91,g_auto/v1/mirroredImages/splashArtImagePromptA%20marionette%20theater%20with%20multiple%20puppeteers%20manipulating%20different%20characters/kehilmgftixxsfu9txcb
:WORD_COUNT: 13035
:END:
...
/This work was carried out while at/ [[https://www.conjecture.dev/][Conjecture]] /./
...
- A while ago when I was trying to avoid having to write this post by hand, I prompted GPT-3 with an early outline of this post. I’ve spliced in some excerpts from it, ~indicated by this style~. Prompt, generated text, and curation metrics [[https://generative.ink/artifacts/simulators/][here]].
...
GPT is not a new form of AI in terms of its training methodology and outer objective: sequence generation from statistical models of data is an old idea. In 1951, Claude Shannon described using [[https://en.wikipedia.org/wiki/N-gram][n-grams]] to approximate conditional next-letter probabilities of a text dataset and "reversed" to generate text samples [fn:1]. I don't know of any other notable advances until the 2010s brought the first interesting language generation results from neural networks. In 2015, Karpathy wrote a blog post/tutorial sharing his excitement about [[http://karpathy.github.io/2015/05/21/rnn-effectiveness/][The Unreasonable Effectiveness of Recurrent Neural Networks]]:
...
At the time, this really was magical (and [[https://en.wikipedia.org/wiki/Uncanny_valley][uncanny]]). How does it know that /miseries/ are /produced upon the soul?/ Or that a /clown/ should address a /lord/ as “sir”? Char-RNNs were like ouija boards, but actually possessed by a low-fidelity ghost summoned from a text corpus. I remember being thrilled by the occasional glimmers of semantic comprehension in a domain of unbounded constructive meaning.
...
Huge mistake! Perhaps I could have started thinking several years earlier about what now seems so fantastically important. But it wasn’t until GPT-3, when I saw the [[https://www.gwern.net/GPT-3][qualitative correlate]] of “loss going down”, that I updated.

I wasn’t the only one [fn:2] whose imagination was naively constrained. A 2016 paper from Google Brain, “ [[https://arxiv.org/abs/1602.02410][Exploring the Limits of Language Modeling]] ”, describes the utility of training language models as follows:
...
Despite its title, this paper’s analysis is entirely myopic. Improving BLEU scores is neat, but how about /modeling general intelligence/ as a downstream task? [[https://arxiv.org/abs/2005.14165][In]] [[https://arxiv.org/abs/2204.02311][retrospect]], an exploration of the /limits/ of language modeling should have read something more like:
...
The paper does, however, mention that making the model bigger improves test perplexity. [fn:3]

I’m only picking on /Jozefowicz et al./ because of their ironic title. I don’t know of any explicit discussion of this limit predating GPT, except a working consensus of Wikipedia editors that [[https://en.wikipedia.org/wiki/Natural-language_understanding][NLU]] is [[https://en.wikipedia.org/wiki/AI-complete#AI-complete_problems][AI-complete]].

The earliest engagement with the hypothetical of “ /what if self-supervised sequence modeling actually works/ ” that I know of is a terse post from 2019, [[https://lesswrong.com/posts/YJRb6wRHp7k39v69n/implications-of-gpt-2][Implications of GPT-2]], by Gurkenglas. It is brief and relevant enough to quote in full:
...
- Some AGI-necessary predictions are [[https://lesswrong.com/posts/pv7Qpu8WSge8NRbpB][too difficult to be learned by even a scaled version of the current paradigm]].
- The irreducible entropy is above the “AGI threshold”: datasets + context windows [[https://twitter.com/ylecun/status/1562162165540331520][contain insufficient information]] to improve on some necessary predictions.
...
A few people did think about what would happen if /agents/ actually worked. The hypothetical limit of a powerful system *optimized to optimize for an objective* drew attention even before reinforcement learning became mainstream in the 2010s. Our current instantiation of AI alignment theory, [[https://lesswrong.com/posts/i4susk4W3ieR5K92u/ai-risk-and-opportunity-humanity-s-efforts-so-far][crystallized by Yudkowsky, Bostrom, et al]], stems from the vision of an arbitrarily-capable system whose cognition and behavior flows from a goal.

But since GPT-3 I’ve [[https://lesswrong.com/s/zpCiuR4T343j9WkcK/p/5JDkW4MYXit2CquLs][noticed]], in my own thinking and in alignment discourse, a dissonance between theory and practice/phenomena, as the behavior and nature of actual systems that seem nearest to AGI also resist /short descriptions in the dominant ontology/.

I only recently discovered the question “ [[https://lesswrong.com/posts/dPcKrfEi87Zzr7w6H/is-the-work-on-ai-alignment-relevant-to-gpt][Is the work on AI alignment relevant to GPT?]] ” which stated this observation very explicitly:
...
My belated answer: A lot of prior work on AI alignment is relevant to GPT. I spend most of my time thinking about GPT alignment, and concepts like [[https://lesswrong.com/w/goal-directedness][goal-directedness]], [[https://lesswrong.com/s/r9tYkB2a8Fp4DN8yB][inner/outer alignment]], [[https://lesswrong.com/w/myopia][myopia]], [[https://lesswrong.com/w/corrigibility][corrigibility]], [[https://lesswrong.com/posts/i3BTagvt3HbPMx6PN/embedded-agency-full-text-version][embedded agency]], [[https://lesswrong.com/posts/k54rgSg7GcjtXnMHX/model-splintering-moving-from-one-imperfect-model-to-another-1][model splintering]], and even [[https://lesswrong.com/w/tiling_agents][tiling agents]] are active in the vocabulary of my thoughts. But GPT violates some prior assumptions such that these concepts sound dissonant when applied naively. To usefully harness these preexisting abstractions, we need something like an ontological [[https://en.wikipedia.org/wiki/Adapter_pattern][adapter pattern]] that maps them to the appropriate objects.

GPT’s unforeseen nature also demands new abstractions (the adapter itself, for instance). My thoughts also use load-bearing words that do not inherit from alignment literature. Perhaps it shouldn’t be surprising if the form of the first visitation from [[https://lesswrong.com/posts/tnWRXkcDi5Tw9rzXw/the-design-space-of-minds-in-general][mindspace]] mostly escaped a few years of theory [[https://lesswrong.com/posts/72scWeZRta2ApsKja/epistemological-vigilance-for-alignment#Direct_access__so_far_and_yet_so_close][conducted in absence of its object]].

The purpose of this post is to capture that object (conditional on a predictive self-supervised training story) in words. Why in words? In order to write coherent alignment ideas which reference it! This is difficult in the existing ontology, because unlike the concept of an /agent/, whose /name/ evokes the abstract properties of the system and thereby invites extrapolation, the general category for “a model optimized for an AGI-complete predictive task” has not been given a name [fn:4]. Namelessness can not only be a symptom of the extrapolation of powerful predictors falling through conceptual cracks, but also a cause, because what we can represent in words is /what we can condition on for further generation./ To whatever extent this [[https://en.wikipedia.org/wiki/Language_of_thought_hypothesis][shapes private thinking]], it is a strict constraint on communication, when thoughts must be sent through the bottleneck of words.

I want to hypothesize about LLMs in the limit, because when AI is all of a sudden [[https://www.theverge.com/2020/8/16/21371049/gpt3-hacker-news-ai-blog][writing viral blog posts]], [[https://www.deepmind.com/blog/competitive-programming-with-alphacode][coding competitively]], [[https://arxiv.org/abs/2009.03393][proving theorems]], and [[https://www.washingtonpost.com/technology/2022/06/11/google-ai-lamda-blake-lemoine/][passing the Turing test so hard that the interrogator sacrifices their career at Google to advocate for its personhood]], a process is clearly underway whose limit we’d be foolish not to contemplate. I could directly extrapolate the architecture responsible for these feats and talk about “GPT-N”, a bigger autoregressive transformer. But often some implementation details aren’t as important as the more abstract archetype that GPT represents – I want to speak the [[https://lesswrong.com/posts/FWvzwCDRgcjb9sigb/why-agent-foundations-an-overly-abstract-explanation][true name]] of the solution which unraveled a Cambrian explosion of AI phenomena with /inessential details unconstrained/, as we’d speak of natural selection finding the solution of the “lens” without specifying the prototype’s diameter or focal length.

(Only when I am able to condition on that level of abstraction can I generate metaphors like “language is a [[https://lesswrong.com/s/5g5TkQTe9rmPS5vvM/p/46qnWRSR7L2eyNbMA][lens that sees its flaws]] ”.)
...
- *Agents are convergently dangerous* *for theoretical reasons* like [[https://lesswrong.com/w/instrumental-convergence][instrumental convergence]], [[https://lesswrong.com/w/goodhart-s-law][goodhart]], and [[https://lesswrong.com/w/orthogonality-thesis][orthogonality]].
...
- *Agents are powerful and economically productive.* It’s a reasonable guess that humans will create such systems [[https://mittmattmutt.medium.com/superintelligence-and-moral-blindness-7436300fcb1f][if only because we can]].

The first reason is conceptually self-contained and remains compelling. The second and third, grounded in the state of the world, has been shaken by the current climate of AI progress, where products of self-supervised learning generate most of the buzz: not even primarily for their SOTA performance in domains traditionally dominated by RL, like games [fn:5], but rather for their virtuosity in domains where RL never even took baby steps, like natural language synthesis.
...
Indeed, [[https://lesswrong.com/posts/8HWGXhnCfAPgJYa9D/pitfalls-of-the-agent-model][Alex Flint warned]] of the potential consequences of leaving this assumption unchallenged:
...
If there are other ways of constructing AI, might we also avoid some of the scary, theoretically hard-to-avoid side-effects of optimizing an agent like [[https://lesswrong.com/w/instrumental-convergence][instrumental convergence]]? GPT provides an interesting example.

GPT doesn’t seem to care which agent it simulates, nor if the scene ends and the agent is effectively destroyed. This is not corrigibility in [[https://ai-alignment.com/corrigibility-3039e668638][Paul Christiano’s formulation]], where the policy is “okay” with being turned off or having its goal changed in a positive sense, but has many aspects of the [[https://lesswrong.com/w/corrigibility][negative formulation found on Arbital]]. It is corrigible in this way because a major part of the agent specification (the prompt) is not fixed by the policy, and the policy lacks direct training incentives to control its prompt [fn:9], as it never generates text or otherwise influences its prompts during training. It’s /we/ who choose to sample tokens from GPT’s predictions and append them to the prompt at runtime, and the result is not always helpful to any agents who may be programmed by the prompt. The downfall of the ambitious villain from an oversight committed in hubris is a predictable narrative pattern. [fn:10] So is the end of a scene.

In general, the model’s prediction vector could point in any direction relative to the predicted agent’s interests. I call this the *prediction orthogonality thesis:* /A model whose objective is prediction/ [fn:11] /can simulate agents who optimize toward any objectives, with any degree of optimality (bounded above but not below by the model’s power)./

This is a corollary of the classical [[https://lesswrong.com/w/orthogonality-thesis][orthogonality thesis]], which states that agents can have any combination of intelligence level and goal, combined with the assumption that agents can in principle be predicted. A single predictive model may also predict multiple agents, either independently (e.g. in different conditions), or interacting in a multi-agent simulation. A more optimal predictor is not restricted to predicting more optimal agents: being smarter does not make you unable to predict stupid systems, nor things that aren’t agentic like the [[https://en.wikipedia.org/wiki/History_of_numerical_weather_prediction][weather]].

Are there any constraints on what a predictive model can be at all, other than computability? Only that it makes sense to talk about its “prediction objective”, which implies the existence of a “ground truth” distribution to which the predictor’s optimality is measured. Several words in that last sentence may conceal labyrinths of nuance, but for now let’s wave our hands and say that if we have some way of presenting [[https://lesswrong.com/posts/QrhAeKBkm2WsdRYao/searching-for-bayes-structure][Bayes-structure]] with evidence of a distribution, we can build an optimization process whose outer objective is optimal prediction.

We can specify some types of outer objectives using a ground truth distribution that we cannot with a utility function. As in the case of GPT, there is no difficulty in incentivizing a model to /predict/ actions that are [[https://lesswrong.com/w/corrigibility][corrigible]], [[https://aiimpacts.org/what-do-coherence-arguments-imply-about-the-behavior-of-advanced-ai/][incoherent]], [[https://lesswrong.com/posts/msJA6B9ZjiiZxT6EZ/lawful-uncertainty][stochastic]], [[https://lesswrong.com/posts/6ddcsdA2c2XpNpE5x/newcomb-s-problem-and-regret-of-rationality][irrational]], or otherwise anti-natural to expected utility maximization. All you need is evidence of a distribution exhibiting these properties.
...
- When there is insufficient information to predict the next token with certainty, [[https://en.wikipedia.org/wiki/Scoring_rule#Proper_scoring_rules][log-loss incentivizes a probabilistic output]]. Utility maximizers [[https://lesswrong.com/posts/msJA6B9ZjiiZxT6EZ/lawful-uncertainty][aren’t supposed to become more stochastic]] in response to uncertainty.

Everything can be trivially modeled as a utility maximizer, but for these reasons, a utility function is not a good explanation or compression of GPT’s training data, and its optimal predictor is not well-described as a utility maximizer. However, just because information isn’t compressed well by a utility function doesn’t mean it can’t be compressed another way. The [[https://en.wikipedia.org/wiki/Mandelbrot_set][Mandelbrot set]] is a complicated pattern compressed by a very simple generative algorithm which makes no reference to future consequences and doesn’t involve argmaxxing anything (except vacuously [[https://lesswrong.com/posts/d2n74bwham8motxyX/optimization-at-a-distance#An_Agent_Optimizing_Its_Own_Actions][being the way it is]]). Likewise the set of all possible rollouts of [[https://en.wikipedia.org/wiki/Conway%27s_Game_of_Life][Conway’s Game of Life]] – [[https://lesswrong.com/posts/3SG4WbNPoP8fsuZgs/agency-in-conway-s-game-of-life][some automata may be well-described as agents]], but they are a minority of possible patterns, and not all agentic automata will share a goal. Imagine trying to model Game of Life as an expected utility maximizer!

There are interesting things that are not utility maximizers, some of which qualify as AGI or [[https://forum.effectivealtruism.org/topics/transformative-artificial-intelligence][TAI]]. Are any of them something we’d be better off creating than a utility maximizer? An inner-aligned GPT, for instance, gives us a way of instantiating goal-directed processes which can be tempered with normativity and freely terminated in a way that is not anti-natural to the training objective. There’s much more to say about this, but for now, I’ll bring it back to how GPT defies the agent orthodoxy.

The crux stated earlier can be restated from the perspective of training stories: *In the agentic AI ontology, the* /*direction of optimization pressure applied by training*/ *is in the direction of the effective agent’s objective function, but in GPT’s case it is (most generally) orthogonal.* [fn:12]
...
Even though neither GPT’s behavior nor its training story fit with the traditional agent framing, there are still compatibilist views that characterize it as some kind of agent. For example, Gwern has said [fn:13] that anyone who uses GPT for long enough begins to think of it as an agent who only cares about roleplaying a lot of roles.
...
(I don’t mean to imply that Gwern thinks this about GPT [fn:15], just that his words do not properly rule out this interpretation. It’s a likely enough interpretation that [[https://lesswrong.com/posts/57sq9qA3wurjres4K/ruling-out-everything-else][ruling it out]] is important: I’ve seen multiple people suggest that GPT might want to generate text which makes future predictions easier, and this is something that can happen in some forms of self-supervised learning – see the note on GANs in the appendix.)
...
While the alignment sphere favors the agent frame for thinking about GPT, in /capabilities/ research distortions tend to come from a lens inherited from /supervised learning/. Translated into alignment ontology, the effect is similar to viewing GPT as an “ [[https://publicism.info/philosophy/superintelligence/11.html][oracle AI]] ” – a view not altogether absent from conceptual alignment, but most influential in the way GPT is used and evaluated by machine learning engineers.

Evaluations for language models tend to look like evaluations for /supervised/ models, consisting of close-ended question/answer pairs – often because they /are/ evaluations for supervised models. Prior to the LLM paradigm, language models were trained and tested on evaluation datasets like [[https://en.wikipedia.org/wiki/Winograd_schema_challenge][Winograd]] and [[https://super.gluebenchmark.com/][SuperGLUE]] which consist of natural language question/answer pairs. The fact that large pretrained models performed well on these same NLP benchmarks without supervised fine-tuning was a novelty. The titles of the GPT-2 and GPT-3 papers, [[https://d4mucfpksywv.cloudfront.net/better-language-models/language_models_are_unsupervised_multitask_learners.pdf][Language Models are Unsupervised Multitask Learners]] and [[https://arxiv.org/abs/2005.14165][Language Models are Few-Shot Learners]], respectively articulate surprise that /self-supervised/ models implicitly learn supervised tasks during training, and can learn supervised tasks at runtime.

Of all the possible papers that could have been written about GPT-3, OpenAI showcased its ability to extrapolate the pattern of question-answer pairs (few-shot prompts) from supervised learning datasets, a novel capability they called “meta-learning”. This is a weirdly specific and indirect way to break it to the world that you’ve created an AI able to extrapolate semantics of arbitrary natural language structures, especially considering that in many cases the [[https://arxiv.org/abs/2102.07350][few-shot prompts were actually unnecessary]].
...
These are essentially the assumptions of oracle AI, as [[https://publicism.info/philosophy/superintelligence/11.html][described by Bostrom]] and [[https://www.lesswrong.com/tag/oracle-ai/history][in subsequent usage]].

So influential has been this miscalibrated perspective that [[https://www.gwern.net/GPT-3#prompts-as-programming][Gwern]], [[https://lesswrong.com/posts/pv7Qpu8WSge8NRbpB][nostalgebraist]] and [[https://generative.ink/posts/language-models-are-0-shot-interpreters/#0-shot-few-shot-and-meta-learning][myself]] – who share a peculiar model overlap due to intensive firsthand experience with the downstream behaviors of LLMs – have all repeatedly complained about it. I’ll repeat some of these arguments here, tying into the view of GPT as an oracle AI, and separating it into the two assumptions inspired by supervised learning.
...
GPT does not consistently try to say [[https://lesswrong.com/posts/BnDF5kejzQLqd5cjH/alignment-as-a-bottleneck-to-usefulness-of-gpt-3][true/correct things]]. This is not a bug – if it had to say true things all the time, GPT would be much constrained in its ability to [[https://twitter.com/dril_gpt2][imitate Twitter celebrities]] and write fiction. Spouting falsehoods in some circumstances is incentivized by GPT’s outer objective. If you ask GPT a question, it will instead answer the question “what’s the next token after ‘{your question}’”, which will often diverge significantly from an earnest attempt to answer the question directly.
...
– [[https://www.reddit.com/r/rational/comments/lvn6ow/gpt3_just_figured_out_the_entire_mystery_plot_of/][Reddit post by u/Sophronius]]
#+end_quote

But even when these strategies seem to work, there is no guarantee that they elicit anywhere near optimal question-answering performance, compared to another prompt in the innumerable space of prompts that would cause GPT to attempt the task, or compared to what the [[https://lesswrong.com/w/eliciting-latent-knowledge-elk][model “actually” knows]].

This means that no benchmark which evaluates downstream behavior is guaranteed or even expected to probe the upper limits of GPT’s capabilities. In nostalgebraist’s words, we have no [[https://lesswrong.com/posts/pv7Qpu8WSge8NRbpB#4__on_ecological_evaluation][ecological evaluation]] of self-supervised language models – one that measures performance in a situation where the model is incentivised to perform as well as it can on the measure [fn:16].

As nostalgebraist [[https://slatestarcodex.com/2020/06/10/the-obligatory-gpt-3-post/#comment-912529][elegantly puts it]]:
...
Benchmarks derived from supervised learning test GPT’s ability to produce correct answers, not to produce /questions/ which cause it to produce a correct answer down the line. But GPT is capable of the latter, and that is how it is the [[https://ai.googleblog.com/2022/05/language-models-perform-reasoning-via.html][most powerful]].

The supervised mindset causes capabilities researchers to focus on closed-form tasks rather than GPT’s ability to simulate open-ended, indefinitely long processes [fn:18], and as such to overlook multi-step inference strategies like chain-of-thought prompting. Let’s see how the oracle mindset causes a blind spot of the same shape in the imagination of a hypothetical alignment researcher.

Thinking of GPT as an oracle brings strategies to mind like asking GPT-N to predict a [[https://lesswrong.com/posts/nXeLPcT9uhfG3TMPS/conditioning-generative-models][solution to alignment from 2000 years in the future]].).

There are various problems with this approach to solving alignment, of which I’ll only mention one here: even assuming this prompt is /outer aligned/ [fn:19] in that a logically omniscient GPT would give a useful answer, it is probably not the best approach for a finitely powerful GPT, because the /process/ of generating a solution in the order and resolution that would appear in a future article is probably far from the optimal /multi-step algorithm/ for computing the answer to an unsolved, difficult question.

GPTs ability to arrive at true answers depends on not only the space to solve a problem in multiple steps (of the [[https://blog.eleuther.ai/factored-cognition/][right granularity]]), but also the direction of the flow of evidence in that /time/. If we’re ambitious about getting the truth from a finitely powerful GPT, we need to incite it to predict truth-seeking processes, not just ask it the right questions. Or, in other words, the more general problem we have to solve is not asking GPT the question [fn:20] that makes it output the right answer, but asking GPT the question that makes it output the right question (…) that makes it output the right answer. [fn:21] A question anywhere along the line that elicits a premature attempt at an answer could [[https://generative.ink/posts/methods-of-prompt-programming/#avoiding-rationalization][neutralize the remainder of the process into rationalization]].
...
[[https://res.cloudinary.com/lesswrong-2-0/image/upload/v1674094431/mirroredImages/vJFdjigzmcXMhNTsx/ym62sehxy5r0965jfx1u.png]] [fn:22]
...
I’ve sometimes seen GPT casually classified as [[https://publicism.info/philosophy/superintelligence/11.html][tool AI]]. GPTs resemble tool AI from the outside, like it resembles oracle AI, because it is often deployed semi-autonomously for tool-like purposes (like helping me draft this post):
...
The final category I’ll analyze is behavior cloning, a designation for predictive learning that I’ve mostly seen used in contrast to RL. According to an [[https://www.sciencedirect.com/science/article/pii/S1474667017467164][article from 1995]], “Behavioural cloning is the process of reconstructing a skill from an operator’s behavioural traces by means of Machine Learning techniques.” The term “mimicry”, as [[https://ai-alignment.com/against-mimicry-6002a472fc42][used by Paul Christiano]], means the same thing and has similar connotations.
...
Behavior cloning / mimicry is also associated with the assumption that capabilities of the simulated processes are strictly [[https://ai-alignment.com/against-mimicry-6002a472fc42][bounded by the capabilities of the demonstrator(s)]]. A supreme counterexample is the [[https://arxiv.org/abs/2106.01345][Decision Transformer]], which can be used to run processes which achieve SOTA for offline reinforcement learning despite being trained on /random/ trajectories. Something which can predict everything all the time is more formidable than any demonstrator it predicts: the upper bound of what can be learned from a dataset is not the most capable trajectory, but the conditional structure of the universe implicated by their sum (though it may not be trivial to [[https://lesswrong.com/w/eliciting-latent-knowledge-elk][extract that knowledge]]).
...
To know the conditional structure of the universe [fn:27] is to know its laws of physics, which describe what is expected to happen under what conditions. The laws of physics are always fixed, but produce different distributions of outcomes when applied to different conditions. Given a sampling of trajectories – examples of situations and the outcomes that actually followed – we can try to infer a common law that generated them all. In expectation, the laws of physics are always implicated by trajectories, which (by definition) fairly sample the conditional distribution given by physics. Whatever humans know of the laws of physics governing the evolution of our world has been inferred from sampled trajectories.

If we had access to an unlimited number of trajectories starting from every possible condition, we could converge to the true laws by simply counting the frequencies of outcomes for every initial state (an [[https://en.wikipedia.org/wiki/N-gram][n-gram]] with a sufficiently large n). In some sense, physics contains the same information as an infinite number of trajectories, but it’s possible to represent physics in a more compressed form than a huge lookup table of frequencies if there are regularities in the trajectories.
...
If you’ve guessed the laws of physics, you now have the ability to compute probabilistic simulations of situations that evolve according to those laws, starting from any conditions [fn:28]. This applies even if you’ve guessed the /wrong/ laws; your simulation will just systematically diverge from reality.
...
– Blake Lemoine [[https://cajundiscordian.medium.com/what-is-lamda-and-what-does-it-want-688632134489][articulating confusion about LaMDA’s nature]]
#+end_quote
...
The verdict that knowledge is purely a property of configurations cannot be naively generalized from real life to GPT simulations, because “physics” and “configurations” play different roles in the two (as I’ll address in the next post). The parable of the two tests, however, literally pertains to GPT. People have a tendency to draw [[https://en.wikipedia.org/wiki/Fallacy_of_composition][erroneous global conclusions]] about GPT from behaviors which are in fact prompt-contingent, and consequently there is a pattern of constant discoveries that GPT-3 exceeds previously measured capabilities given alternate conditions of generation [fn:29], which shows no signs of slowing 2 years after GPT-3’s release.
...
In the simulation ontology, I say that GPT and its output-instances correspond respectively to the *simulator* and *simulacra*. *GPT* is to a *piece of text output by GPT* as *quantum physics* is to a *person taking a test*, or as [[https://en.wikipedia.org/wiki/Conway%27s_Game_of_Life#Rules][transition rules of Conway’s Game of Life]] are to [[https://conwaylife.com/wiki/Glider][glider]]. The simulator is a time-invariant law which unconditionally governs the evolution of all simulacra.
...
- Is GPT [[https://lesswrong.com/w/myopia][myopic]]?
- Is GPT [[https://lesswrong.com/w/corrigibility][corrigible]]?
- Is GPT [[https://arxiv.org/abs/2110.10819][delusional]]?
- Is GPT [[https://lesswrong.com/posts/H9knnv8BWGKj6dZim/usd1000-bounty-for-openai-to-show-whether-gpt3-was][pretending to be stupider than it is]]?
- Is GPT computationally equivalent to a [[https://en.wikipedia.org/wiki/Finite-state_machine][finite automaton]]?
- Does GPT [[https://lesswrong.com/posts/WmBukJkEFM72Xr397/mesa-search-vs-mesa-control][search]]?
- Can GPT distinguish correlation and [[https://lesswrong.com/posts/yZb5eFvDoaqB337X5/investigating-causal-understanding-in-llms][causality]]?
- Does GPT have superhuman knowledge?
- Can GPT [[https://lesswrong.com/w/recursive-self-improvement][write its successor]]?
...
– Aiyen’s [[https://lesswrong.com/posts/YRtzpJHhoFWxbjCso/what-would-it-look-like-if-it-looked-like-agi-was-very-near?commentId=5BGTbapdmtSGajtez][comment]] on [[https://lesswrong.com/posts/YRtzpJHhoFWxbjCso/what-would-it-look-like-if-it-looked-like-agi-was-very-near][What would it look like if it looked like AGI was very near?]]
#+end_quote
...
In my model, these updates dramatically alter the landscape of potential futures, and thus motivate [[https://intelligence.org/files/ExploratoryEngineeringAI.pdf][exploratory engineering]] of the class of learned simulators for which GPT-3 is a lower bound. That is the intention of this sequence.
...
- *Novel methods of process/agent specification.* Simulators like GPT give us methods of instantiating intelligent processes, including goal-directed agents, with methods other than optimizing against a reward function.
  - *Conditioning.* GPT can be controlled to an impressive extent by prompt programming. Conditioning preserves distributional properties in potentially desirable but also potentially undesirable ways, and it’s not clear how out-of-distribution conditions will be interpreted by powerful simulators.
    - Several posts have been made about this recently:
      - [[https://lesswrong.com/posts/nXeLPcT9uhfG3TMPS/conditioning-generative-models][Conditioning Generative Models]].) and [[https://lesswrong.com/posts/adiszfnFgPEnRsGSr/conditioning-generative-models-with-restrictions][Conditioning Generative Models with Restrictions]] by Adam Jermyn
      - [[https://lesswrong.com/posts/JqnkeqaPseTgxLgEL/conditioning-generative-models-for-alignment][Conditioning Generative Models for Alignment]] by Jozdien
      - [[https://lesswrong.com/posts/dWJNFHnC4bkdbovug/training-goals-for-large-language-models][Training goals for large language models]] by Johannes Treutlein
      - [[https://lesswrong.com/posts/HAz7apopTzozrqW2k/strategy-for-conditioning-generative-models][Strategy For Conditioning Generative Models]] by James Lucassen and Evan Hubinger
    - Instead of conditioning on a prompt ("observable" variables), we might also control generative models by [[https://rome.baulab.info/][conditioning on latents]].
  - *Distribution specification.* What kind of conditional distributions could be used for training data for a simulator? For example, the [[https://arxiv.org/abs/2106.01345][decision transformer]] dataset is constructed for the intent of outcome-conditioning.
  - *Other methods.* When pretrained simulators are modified by methods like [[https://arxiv.org/abs/2009.01325][reinforcement learning from human feedback]], [[https://lesswrong.com/posts/k7oxdbNaGATZbtEg3/redwood-research-s-current-project][rejection sampling]], [[https://arxiv.org/abs/2203.14465][STaR]], etc, how do we expect their behavior to diverge from the simulation objective?
...
- *How does predictive learning generalize?* Many of the above considerations are influenced by how predictive learning generalizes out-of-distribution..
  ...
  - Will powerful models predict [[https://lesswrong.com/posts/JqnkeqaPseTgxLgEL/conditioning-generative-models-for-alignment][self-fulfilling]] [[https://lesswrong.com/posts/dWJNFHnC4bkdbovug/training-goals-for-large-language-models][prophecies]]?
...
| *GANs* | X [fn:30] | ? |  | X | X | X |
| *Diffusion* | X [fn:30] | ? |  | X | X | X |
| *Model-based RL transition function* | X | X | X | X | X | X |
| *Game of life* |  | N/A | X | X |  |  |
| *Physics* |  | N/A | X | X | X |  |
| *Human imagination* | X [fn:31] |  | X | X | X | X |
| *SimCity* |  | N/A | X | X | X |  |

[fn:1] [[https://www.princeton.edu/~wbialek/rome/refs/shannon_51.pdf][Prediction and Entropy of Printed English]]

[fn:2] A few months ago, I asked Karpathy whether he ever thought about what would happen if language modeling actually worked someday when he was implementing char-rnn and writing [[http://karpathy.github.io/2015/05/21/rnn-effectiveness/][The Unreasonable Effectiveness of Recurrent Neural Networks]]. No, he said, and he seemed similarly mystified as myself as to why not.

[fn:3] “Unsurprisingly, size matters: when training on a very large and complex data set, fitting the training data with an LSTM is fairly challenging. Thus, the size of the LSTM layer is a very important factor that influences the results(...). The best models are the largest we were able to fit into a GPU memory.”

[fn:4] It strikes me that this description may evoke “oracle”, but I’ll argue shortly that this is not the limit which prior usage of “oracle AI” has pointed to.

[fn:5] [[https://arxiv.org/abs/2205.15241][Multi-Game Decision Transformers]]

[fn:6] from [[https://dailynous.com/2020/07/30/philosophers-gpt-3/#chalmers][Philosophers On GPT-3]]

[fn:7] [citation needed]

[fn:8] they are not [[https://lesswrong.com/posts/dKTh9Td3KaJ8QW6gw/why-assume-agis-will-optimize-for-fixed-goals][wrapper]] [[https://lesswrong.com/posts/Mrz2srZWc7EzbADSo/wrapper-minds-are-the-enemy][minds]]

[fn:9] although a simulated character might, if they knew what was happening.

[fn:10] You might say that it’s the will of a different agent, the author. But this pattern is learned from accounts of [[https://lesswrong.com/posts/sYgv4eYH82JEsTD34/beyond-the-reach-of-god][real life]] as well.

[fn:11] Note that this formulation assumes inner alignment to the prediction objective.

[fn:12] Note that this is a distinct claim from that of [[https://lesswrong.com/s/nyEFg3AuJpdAozmoX][Shard Theory]], which says that the effective agent(s) will not optimize for the outer objective /due to inner misalignment./ Predictive orthogonality refers to the outer objective and the form of idealized inner-aligned policies.

[fn:13] In the Eleuther discord

[fn:14] And if there is an inner alignment failure such that GPT forms preferences over the consequences of its actions, it’s not clear a priori that it will care about non-myopic text prediction over something else.

[fn:15] Having spoken to Gwern since, his perspective seems more akin to seeing physics as an agent that [[https://en.wikipedia.org/wiki/Principle_of_minimum_energy][minimizes free energy]], a [[https://en.wikipedia.org/wiki/Free_energy_principle][principle]] which extends into the domain of self-organizing systems. I think this is a nuanced and valuable framing, with a potential implication/hypothesis that dynamical world models like GPT must learn the same type of optimizer-y cognition as agentic AI.

[fn:16] except arguably log-loss on a self-supervised test set, which isn’t very interpretable

[fn:17] The way GPT is trained actually processes each token as question and answer simultaneously.

[fn:18] One could argue that the focus on closed-ended tasks is necessary for benchmarking language models. Yes, and the focus on capabilities measurable with standardized benchmarks is part of the supervised learning mindset.

[fn:19] to abuse the term

[fn:20] Every usage of the word “question” here is in the functional, not semantic or grammatical sense – any prompt is a question for GPT.

[fn:21] Of course, there are also other interventions we can make except asking the right question at the beginning.

[fn:22] table from [[https://arxiv.org/abs/2203.02155][“Training language models to follow instructions with human feedback”]]

[fn:23] Jean Baudrillard, Simulacra and Simulation

[fn:24] A [[https://en.wikipedia.org/wiki/Scoring_rule#Proper_scoring_rules][proper scoring rule]] is optimized by predicting the “true” probabilities of the distribution which generates observations, and thus incentivizes honest probabilistic guesses. Log-loss (such as GPT is trained with) is a proper scoring rule.

[fn:25] Predictive accuracy is deontological with respect to the output as an /action/, but may still incentivize instrumentally convergent inner implementation, with the output prediction itself as the “consequentialist” objective.

[fn:26] This isn’t strictly true because of attention gradients: GPT's computation is optimized not only to predict the next token correctly, but also to cause /future tokens to be predicted correctly/ when looked up by attention. I may write a post about this in the future.

[fn:27] actually, the [[https://generative.ink/posts/language-models-are-multiverse-generators/][multiverse]], if physics is stochastic

[fn:28] The reason we don’t see a bunch of simulated alternate universes after humans guessed the laws of physics is because our reality has a huge state vector, making evolution according to the laws of physics infeasible to compute. Thanks to locality, we do have simulations of small configurations, though.

[fn:29] Prompt programming only: [[https://arxiv.org/abs/2102.07350][beating OpenAI few-shot benchmarks with 0-shot prompts]], [[https://generative.ink/posts/list-sorting-does-not-play-well-with-few-shot/][400% increase in list sorting accuracy with 0-shot Python prompt]], [[https://arxiv.org/abs/2102.09690][up to 30% increase in benchmark accuracy from changing the order of few-shot examples]], and, uh, [[https://twitter.com/BlancheMinerva/status/1537952688972787713][30% increase in accuracy after capitalizing the ground truth]]. And of course, factored cognition/chain of thought/inner monologue: check out this awesome [[https://www.gwern.net/docs/ai/nn/transformer/gpt/inner-monologue/][compilation]] by Gwern.

[fn:30] GANs and diffusion models can be unconditioned (unsupervised) or conditioned (self-supervised)

[fn:31] The human imagination is surely shaped by self-supervised learning (predictive learning on e.g. sensory datastreams), but probably also other influences, including innate structure and reinforcement.
